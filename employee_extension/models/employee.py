...
class HrEmployee(models.Model):
    ...
    usc_yearly_rate_1 = fields.Float('USC yearly cut off 1', compute='compute_rpn_values')
    usc_yearly_rate_2 = fields.Float('USC yearly cut off 2', compute='compute_rpn_values')
    usc_yearly_rate_3 = fields.Float('USC yearly cut off 3', compute='compute_rpn_values')
    usc_yearly_rate_4 = fields.Float('USC yearly cut off 4', compute='compute_rpn_values')
...
class HrEmployeeRPN(models.Model):
    ...
    usc_yearly_rate_1 = fields.Float('USC yearly cut off 1')
    usc_yearly_rate_2 = fields.Float('USC yearly cut off 2')
    usc_yearly_rate_3 = fields.Float('USC yearly cut off 3')
    usc_yearly_rate_4 = fields.Float('USC yearly cut off 4')
